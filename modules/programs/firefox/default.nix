...
in
{
  options.configured.programs."${module_name}" = {
    ...
    enableLocalExtensions =
      mkEnableOption "Enable if you do not use your Firefox login for extensions"
      // {
        default = true;
      };
  ...
  config = mkMerge [
      ...
      home-manager.users.${username} =
        let
          ...
          profilesPath =
            ...
            in
            if isDarwin then "${configPath}/Profiles" else configPath;
        in
        {
          programs.firefox = {
            enable = true;
            ...
            profiles.profile_0 = {
              ...
              extensions.packages =
                ...
                mkIf cfg.enableLocalExtensions [
                  bitwarden
                  ublock-origin
          ...
          # Arkenfox
          home.file = mkMerge (
            flip mapAttrsToList hmConfig.programs.firefox.profiles (
              _: profile: {
    ...
    (mkIf config.impermanence.enable {
      home-manager.users.${username}.home.persistence."/persist/home/${username}".directories = [
        ".mozilla/firefox"
      ];
    })
  ];
